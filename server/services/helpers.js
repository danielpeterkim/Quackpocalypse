...
const locationsInit = {
    ...
    EAS: { diseaseCubes: diseaseCubeInit, researchStation: false, adjacent: ["Carnegie", "ABS", "EAS Lawn", "Sig Ep", "Burchard"], id: 8 },
    ...
    Pierce: { diseaseCubes: diseaseCubeInit, researchStation: false, adjacent: ["Morton", "Kidde", "River Terrace"], id: 19 },
    ...
    '8th Street Lot': { diseaseCubes: diseaseCubeInit, researchStation: false, adjacent: ["Baseball Field", "Palmer", "Jonas"], id: 31 },
    ...
    Palmer: { diseaseCubes: diseaseCubeInit, researchStation: false, adjacent: ["Howe Circle", "8th Street Lot", "Library","Volleyball Courts", "Humphreys"], id: 35 },
    'Howe Lot': { diseaseCubes: diseaseCubeInit, researchStation: false, adjacent: ["Howe Circle", "Howe", "Volleyball Courts"], id: 36 },
    ...
    Jonas: { diseaseCubes: diseaseCubeInit, researchStation: false, adjacent: ["Lodge", "Student Wellness Center", "Chi Phi", "8th Street Lot"], id: 39 },
    Humphreys: { diseaseCubes: diseaseCubeInit, researchStation: false, adjacent: ["Student Wellness Center", "Martha", "Volleyball Courts", "Palmer"], id: 40 },
    'Volleyball Courts': { diseaseCubes: diseaseCubeInit, researchStation: false, adjacent: ["Palmer", "Humphreys", "Martha", "Howe Lot"], id: 41 },
    ...
    'Student Wellness Center': { diseaseCubes: diseaseCubeInit, researchStation: false, adjacent: ["Piskies", "Jonas", "Humphreys", "Tennis Courts"], id: 44 },
    'Lodge': { diseaseCubes: diseaseCubeInit, researchStation: false, adjacent: ["Chi Phi", "Piskies", "Jonas"], id: 45 },
    'Tennis Courts': { diseaseCubes: diseaseCubeInit, researchStation: false, adjacent: ["Castle Point", "Castle Point Lot", "Student Wellness Center"], id: 46 },
